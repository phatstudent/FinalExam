...
<html lang="en-US">
  <head>
    ...
    <!-- My Style -->
    <link rel="stylesheet" href="<?=ASSETS?>pizza/css/my_css.css">
    <link rel="stylesheet" href="<?=ASSETS?>pizza/css/header.css">
    <link rel="stylesheet" href="<?=ASSETS?>pizza/css/footer.css">
    <link rel="stylesheet" href="<?=ASSETS?>pizza/css/sidebar.css">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
          <div class="container">
            <a class="navbar-brand" href="<?=ROOT?>home">
              <img class="logo-before" style="max-width: 70px;" src="<?=ASSETS?>pizza/img/pizza_logo.png" alt="">
            </a>
